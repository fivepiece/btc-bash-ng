...
testrfc6979_secp256k1_sha256()
{
    ...
    printf '%s\n' ${ret[@]}
    printf "%s\n" ${ret[@]}
    [[ "${ret[0]}" =~ "2442CE9D2B916064108014783E923EC36B49743E2FFA1C4496F01A512AAFD9E5" ]] && \
    [[ "${ret[1]}" =~ "547FE64427496DB33BF66019DACBF0039C04199ABB0122918601DB38A72CFC21" ]] && \
    [[ "${ret[2]}" =~ "6B39CD0EB1BC8603E159EF5C20A5C8AD685A45B06CE9BEBED3F153D10D93BED5" ]] && \
    [[ "${ret[3]}" =~ "58DFCC1E00A35E1572F366FFE34BA0FC47DB1E7189759B9FB233C5B05AB388EA" ]] && \
    [[ "${ret[4]}" =~ "279FA72DD19BFAE05577E06C7C0C1900C371FCD5893F7E1D56A37D30174671F6" ]] && \
    echo "testrfc6979_secp256k1_sha256() passed"
}
